...
We develop a dynamic welfare model of a hedonic housing asset and an associated flow of housing services traded in closely linked, competitive asset and rental markets. The model distinguishes between firms that own the asset and consumers who rent. Assuming an immediate transition to a new steady-state, we consider the effects on a firm and household of an unexpected shock, and we derive present-value welfare change measures for non-marginal and marginal changes in amenities. Our results are consistent with the static measures currently available; however, the dynamic model provides additional details about the distribution of benefits over time, highlighting the inherent pecuniary externalities connecting rental and hedonic asset markets. These pecuniary externalities transfer much of the economic benefits of amenity improvements from households to landlords. We also develop model extensions specific to owner-occupied housing, property taxes. Then we derive a corrective tax and subsidy to offset the increases in rent from the pecuniary externality. We use a brief empirical application to illustrate the immense scale of the benefits of public goods to landlords and costs to households. Our approach is applicable to a wide variety of assets, such as factories, that benefit from public goods and which generate consumer good or services.
\end{abstract}
...
In the context of cost-benefit analysis and public policy, this paper establishes a tax that can be used to make a potential pareto improvement a pareto improvement. Additionally, the role of future renters in determining today's house prices made explicit by a dynamic modeling approach illustrates the importance of not just assessing how a policy impacts property prices regardless of the occupants, but the fundamental importance of assessing how housing costs affect current residents, who may move away to escape rising rents and whose well-being would not be reflected by changes in house prices.
...
%https://www2.census.gov/library/publications/2010/compendia/statab/130ed/tables/11s0446.pdf
